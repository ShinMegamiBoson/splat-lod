...
if (process.argv[1] === fileURLToPath(import.meta.url)) {
    ...
    const summary = await summarize(directory, process.argv.includes('--large') ? LARGE_PROTOCOL : process.argv.includes('--benefit') ? BENEFIT_PROTOCOL : process.argv.includes('--main') ? MAIN_PROTOCOL : PROTOCOL);
